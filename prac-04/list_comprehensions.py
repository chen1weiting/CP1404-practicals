...
# for loop that. a new list containing the first letter of each name
...
# and here's the join string method being used to . a single string from the names like:

# 'Ada Alan Angel Bob Jimi'

print(" ".join(sorted(names)))

# TODO: list comprehension to . a list of all the full_names in lowercase format
...
# greater than 9 from the numbers (not strings) you just  make
...
# to  a string (not list) of the last names for those full names longer than 11 characters
